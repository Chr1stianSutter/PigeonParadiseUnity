...
public class MovingCloudsLeftRight : MonoBehaviour {
    ...
    void Start() {
        pointA = new Vector3(transform.position.x + offsetRight, transform.position.y, transform.position.z);
        pointB = new Vector3(transform.position.x - offsetLeft, transform.position.y, transform.position.z);
    }
